...
//	unsigned long ulBaud = 9600, ulComNo = 3;
//	signed char cResult = 1;
//	int temp = 0;
//
//	printf("Input your COM number:\r\nCOM = ");
//	scanf("%ld", &ulComNo);
//	printf("Input your baud rate:(9600, 115200, etc.)\r\nBaudRate = ");
//	scanf("%ld", &ulBaud);
...
////  fdsafdsa
////
////                  Created by Bluebear on 2017/7/16.
////                    Copyright © 2017年 Bluebaer. 
////                         All rights reserved.
////
//
///*#include <iostream>
